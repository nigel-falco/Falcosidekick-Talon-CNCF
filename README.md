...
```
SECURE_API_TOKEN=**** ./sysdig-cli-scanner --iac --apiurl https://us2.app.sysdig.com/secure /Users/nigeldouglas/Desktop/manifests/*.(yaml|tf) --list-unsupported-resources --output-json iac-scan.json
```

Fixed!
```
SECURE_API_TOKEN=**** ./sysdig-cli-scanner --iac --apiurl https://us2.app.sysdig.com/secure /Users/nigeldouglas/Desktop/manifests/ --list-unsupported-resources --recursive
```
